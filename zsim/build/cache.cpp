...
uint64_t Cache::access(MemReq& req) {
    ...
    if (likely(!skipAccess)) {
        ...
        //std::cout << "CacheCPP1: lineId:" << lineId  << std::endl;
        //std::cout << "CacheCPP1: lineAddr:" << req.lineAddr << std::endl;
        respCycle += accLat;
        ...
        if (lineId == -1 && cc->shouldAllocate(req)) {
            ...
            //std::cout << "CacheCPP2: wbLineAddr:" << wbLineAddr << std::endl;
        ...
        //std::cout << "CacheCPP2: lineId" << lineId  << std::endl;
        //cache_name = name.c_str(); 
        respCycle = cc->processAccess(req, lineId, respCycle, name);
